...
function renderRestoreConflict(index){
  ...
  if(keepCurrentBtn){
    keepCurrentBtn.setAttribute('aria-pressed',choice==='current'?'true':'false');
    keepCurrentBtn.onclick=()=>{
  ...
  if(useBackupBtn){
    useBackupBtn.setAttribute('aria-pressed',choice==='backup'?'true':'false');
