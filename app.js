...
// 🟨 CAMBIO 1: permite eliminar completamente un producto del carrito
...
function setQty(id, qty){
  ...
  // 🟨 CAMBIO 2: al llegar a 0, el producto se elimina
  if(qty <= 0){
    delete cart[id];
    saveCart();
    return;
...
function renderCart(){
  ...
  // 🟨 CAMBIO 3: se agregan controles − / + y botón 🗑️
  ...
  // 🟨 CAMBIO 4: botón − obtiene la cantidad actual antes de restar
  ...
  // 🟨 CAMBIO 6: botón 🗑️ elimina todas las unidades
...
// 🟨 CAMBIO 7: la X del último paso solo cierra el diálogo.
// No envía el formulario ni abre WhatsApp.
